...
print("OPTIMIZACION  XGBOOST: Z VARIABLE")
...
nombre_csv = 'historial_gridsearch_xgboost_z_variable.csv'
...
print(f"\nRENDIMIENTO DEL MEJOR MODELO (XGBOOST - Z VARIABLE)")
...
joblib.dump(mejor_xgb, 'modelo_xgboost_z_variable_campeon.joblib')
joblib.dump(scaler, 'escalador_xgboost_z_variable_campeon.joblib')
