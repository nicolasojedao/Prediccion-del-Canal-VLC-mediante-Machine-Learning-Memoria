...
print("Entrenando Random Forest Z Constante")
...
joblib.dump(rf_baseline, 'modelo_rf_z_constante_baseline.joblib')



# 3. CALCULO Y EXPORTACION DE METRICAS 
...
df_metricas.to_csv("metricas_rf_z_constante.csv", index=False)
print("archivo 'metricas_rf_z_constante.csv' generado\n")
...
plt.title('Rendimiento Global: RF Real vs. Predicho (Z Constante)', fontsize=14, fontweight='bold')
...
plt.legend()
plt.tight_layout()
plt.savefig('diagnostico_rf_const_1_real_vs_predicho.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.title('Residual Plot: Random Forest Z Constante', fontsize=14, fontweight='bold')
plt.xlabel('Ganancia Predicha (Log10)', fontsize=12)
plt.ylabel('Residuo (Real - Predicho)', fontsize=12)
plt.tight_layout()
plt.savefig('diagnostico_rf_const_2_residual_plot.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.title('Mapa Espacial del Error: Random Forest Z Constante', fontsize=14, fontweight='bold')
plt.xlabel('Eje X: Longitud del Túnel (metros)', fontsize=12)
plt.ylabel('Eje Y: Ancho (metros)', fontsize=12)
plt.legend(loc='upper right')
plt.grid(True, linestyle=':', alpha=0.6) 
plt.tight_layout()
plt.savefig('diagnostico_rf_const_3_mapa_espacial.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('diagnostico_rf_const_4_cdf.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('diagnostico_rf_const_5_qq_plot.png', dpi=300, bbox_inches='tight')
plt.close()
