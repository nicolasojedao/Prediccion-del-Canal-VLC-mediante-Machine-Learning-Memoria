...
plt.title('Z Constante: Real vs. Predicho (Log10)', fontsize=14, fontweight='bold')
...
plt.title('Z Constante: Residual Plot', fontsize=14, fontweight='bold')
...
plt.title('Z Constante: Mapa Espacial del Error', fontsize=14, fontweight='bold')
...
plt.title('Z Constante: Probabilidad Acumulada del Error (CDF)', fontsize=14, fontweight='bold')
...
plt.title('Z Constante: QQ-Plot (Normalidad de Residuos)', fontsize=14, fontweight='bold')
