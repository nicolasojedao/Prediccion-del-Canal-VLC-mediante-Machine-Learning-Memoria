...
plt.title('Rendimiento Global: MLP Real vs. Predicho (Z Variable)', fontsize=14, fontweight='bold')
...
plt.title('Residual Plot: MLP Z Variable', fontsize=14, fontweight='bold')
...
plt.title('Mapa Espacial del Error: MLP Z Variable', fontsize=14, fontweight='bold')
...
plt.title('CDF: Probabilidad Acumulada del Error MLP', fontsize=14, fontweight='bold')
...
plt.title('QQ-Plot: Normalidad de Residuos MLP', fontsize=14, fontweight='bold')
