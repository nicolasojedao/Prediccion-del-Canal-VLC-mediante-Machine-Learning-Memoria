...
print("OPTIMIZACION MLP (Z CONST)")
...
# z no se incluye, estamos en constante
...
print("\n--- HIPERPARÁMETROS ÓPTIMOS SELECCIONADOS (Z CONSTANTE) ---")
...
nombre_csv = 'historial_gridsearch_mlp_z_constante_v2.csv'
...
print(f"RENDIMIENTO DEL MODELO MLP Z CONSTANTE")
...
joblib.dump(mejor_mlp, 'modelo_mlp_z_constante_campeon_v2.joblib')
joblib.dump(scaler, 'escalador_mlp_z_constante_campeon_v2.joblib')
print("\nLISTO")